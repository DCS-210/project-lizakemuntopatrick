...
* Outlier video is at link: https://www.youtube.com/watch?v=TG4giyL-4Sk

```{r likes-vs-views, echo = FALSE, message=FALSE, out.width = "70%"}
youtube %>%
  ...
  labs(x = "Number of Views",
       y = "Number of Likes",
       title = "Number of Views vs. Number of Likes") +
...
``` {r violin-plot-funny, echo = FALSE, message = FALSE, warning = FALSE, out.width = "100%"}
youtube %>%
...
.pull-left[
``` {r violin-plot-patriotic, echo = FALSE, warning = FALSE, out.width = "100%"}
youtube %>%
  filter(title != "Frank the Monkey Bud Light") %>%
