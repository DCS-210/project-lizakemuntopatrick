...
.pull-left[
```{r, echo=FALSE, fig.width = 5, fig.align='left', warning = FALSE}
ad_brand <- youtube %>%
            group_by(brand_type) %>%
...
* According to surveys conducted by Statista, there is a 47% likelihood for males to watch the Superbowl and 28% likelihood for females. In addition to this the target audience is largely made up of the 18-49 age demographic. 
]
...
```{r, echo = FALSE, warning = FALSE, fig.align = 'center', out.height= 565, out.width = 900}
